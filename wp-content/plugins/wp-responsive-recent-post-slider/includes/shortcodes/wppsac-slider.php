...
function wprps_recent_post_slider( $atts, $content = null ) {
	...
	if ( $query->have_posts() ) : ?>
		<div class="wppsac-wrap alignwide wppsac-slick-slider-wrp wppsac-clearfix <?php echo esc_attr( $extra_class ); ?>" data-conf="<?php echo htmlspecialchars( json_encode( $slider_conf )); ?>">
