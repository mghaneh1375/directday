	...
	<div class="wppsac-deal-offer-wrap">
		<div class="wppsac-deal-offer"> 
			<div class="wppsac-inn-deal-offer">
				...
				<h4 class="wppsac-inn-deal-sub-hedding"><span style="color:red;">Extra Bonus: </span>Users will get <span>15% off</span> on the regular price using this coupon code.</h4>
			</div>
			<div class="wppsac-inn-deal-offer-btn">
				<div class="wppsac-inn-deal-code"><span>EPS15</span></div>
				<a href="<?php echo WPRPS_PLUGIN_BUNDLE_LINK; ?>"  target="_blank" class="wppsac-sf-btn wppsac-sf-btn-orange"><span class="dashicons dashicons-cart"></span> Get Essential Bundle Now</a>
			</div>
		</div>
	</div>
</div>