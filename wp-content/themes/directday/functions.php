 ...
 *
 * @package WordPress
 * @subpackage DirectDay
 * @since DirectDay 1.0
 */

$SITE_PREFIX = "http://localhost/directday/";
...
if ( ! function_exists( 'twenty_twenty_one_setup' ) ) {
	...
	function twenty_twenty_one_setup() {
		...
		$editor_stylesheet_path = './assets/css/style-editor.css?v=' . time();
...
require get_template_directory() . '/classes/class-directday-colors.php';
new Direct_Day_Colors();
